...
public class Labirint {
    ...
    public void printoLabirintin(Graphics g, int xOffset, int yOffset) {
        for (int i = 0; i < rreshtat; i++) {
            for (int j = 0; j < kolonat; j++) {
                ...
                switch (labirint[i][j]) {
                    case 0:
                        img = new ImageIcon("C:\\Users\\Perdorues\\Pictures\\flokBore.png").getImage();
                        break;
                    case 1:
                        img = new ImageIcon("C:\\Users\\Perdorues\\Pictures\\pema.png").getImage();
                        break;
                    case 2:
                        img = new ImageIcon("C:\\Users\\Perdorues\\Pictures\\dhurata.png").getImage();
                        break;
                    case 3:
                        img = new ImageIcon("C:\\Users\\Perdorues\\Pictures\\NewDoor(1).png").getImage();
                        break;
                    case 4:
                        img = new ImageIcon("C:\\Users\\Perdorues\\Pictures\\NewDoor(1).png").getImage();
                        break;
    ...
    public Image vendosDrejtimin() {
        ...
        switch (KontrolliLojes.drejtimi) {
            case "lart":
                img = new ImageIcon("C:\\Users\\Perdorues\\Pictures\\sprite_3.png").getImage();
                break;
            case "djathtas":
                img = new ImageIcon("C:\\Users\\Perdorues\\Pictures\\sprite_0 (2).png").getImage();
                break;
            case "poshte":
                img = new ImageIcon("C:\\Users\\Perdorues\\Pictures\\sprite_2.png").getImage();
                break;
            case "majtas":
                img = new ImageIcon("C:\\Users\\Perdorues\\Pictures\\sprite_5.png").getImage();
                break;
    }
    return img;
}
